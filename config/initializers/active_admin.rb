ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = ENV.fetch("APP_NAME", "Hotelish")
  ...
  config.comments_registration_name = ActiveAdmin::Comment.model_name.human
  #
  ...
  # config.comments_menu = { priority: 9999 }
  ...
  config.register_stylesheet 'active_admin_printable', media: :print
